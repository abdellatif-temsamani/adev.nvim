return {
    ...
    keys = {
        { "<leader>lf", function() vim.lsp.buf.format() end,          desc = "lint buffer",         mode = { "v", "n" } },
        ...
        { "<leader>lc", function() vim.lsp.buf.code_action() end,     desc = "lsp code action",     mode = { "n", "v" } },
        { "<leader>ls", function() vim.lsp.buf.signature_help() end,  desc = "lsp signature help", },
        { "<leader>ll", function() vim.diagnostic.open_float() end,   desc = "line diagnostic", },
