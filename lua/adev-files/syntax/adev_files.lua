...
vim.api.nvim_set_hl(0, "adevFilesPendingCopy", { link = "adevFilesGitCopied", bold = true, default = true })
vim.api.nvim_set_hl(0, "adevFilesPendingMove", { link = "adevFilesGitModified", bold = true, default = true })
vim.api.nvim_set_hl(0, "adevFilesPendingNew", { link = "adevFilesGitAdded", bold = true, default = true })
vim.api.nvim_set_hl(0, "adevFilesPendingRenamed", { link = "adevFilesGitRenamed", bold = true, default = true })
