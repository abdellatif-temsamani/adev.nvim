...
keymap_set(
    ...
    "<leader>Q",
    "<cmd>quitall<CR>",
    { noremap = true, silent = true, desc = "quit nvim" }
)
...
keymap_set(
    ...
    "<leader>wo",
    "<cmd>tabnew<cr>",
    { noremap = true, silent = true, desc = "new tab" }
)
...
keymap_set(
    ...
    "<leader>qp",
    "<cmd>cprevious<cr>",
    { noremap = true, silent = true, desc = "prev quickfix" }
)
keymap_set(
    "n",
    "<leader>qn",
    "<cmd>cnext<cr>",
    { noremap = true, silent = true, desc = "next quickfix" }
)
...
keymap_set(
    ...
    "<leader>cc",
    ':"<,">fold<CR>',
    { noremap = true, silent = true, desc = "create fold" }
)
keymap_set(
    "n",
    "<leader>co",
    "<cmd>foldopen<CR>",
    { noremap = true, silent = true, desc = "open fold" }
)
keymap_set(
    "n",
    "<leader>cq",
    "<cmd>foldclose<CR>",
    { noremap = true, silent = true, desc = "close fold" }
)
